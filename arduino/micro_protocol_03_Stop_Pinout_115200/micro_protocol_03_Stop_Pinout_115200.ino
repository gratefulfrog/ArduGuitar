/* micro_protocol 03 Stop Pinout
 * This is a test version to see if clicking still occurse when
 * Arduino does no pin operations, just serial I/O.
...
void executeIncomingString(){
  ...
  // this stops pinouts       
  if (recMsgLimit-- <=0) { // no more pinout
    msg("x77777");
    return;
  }
